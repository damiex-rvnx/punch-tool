...
// ─── LOGO ────────────────────────────────────────────────────────────────────
// Replace LOGO_PLACEHOLDER with the actual base64 data URI of the logo PNG
...
export default function App() {
  ...
  const logoEl = LOGO !== 'LOGO_PLACEHOLDER'
    ? <img src={LOGO} alt="QwikResponse" style={{ display: 'block', margin: '0 auto', width: '68%', maxWidth: 260, minWidth: 180, height: 'auto' }} />
    : (
      <div style={{ display: 'block', margin: '0 auto', width: '68%', maxWidth: 260, minWidth: 180, background: '#2c2c2e', borderRadius: 12, padding: '18px 20px', textAlign: 'center' }}>
        <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 22, fontWeight: 900, color: '#f2f2f7', letterSpacing: '0.08em' }}>QWIK<span style={{ color: '#e5342a' }}>RESPONSE</span></div>
        <div style={{ fontSize: 10, color: '#636366', letterSpacing: '0.18em', marginTop: 2 }}>RESTORATION &amp; CONSTRUCTION</div>
      </div>
    )
